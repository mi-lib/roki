...
static void _rkJointFloatCopyPrp(void *prp1, void *prp2){}
...
static void _rkJointFloatSetMinMax(void *prp, double *val){}
...
static void _rkJointFloatGetMin(void *prp, double *val){
  val[0] = val[1] = val[2] = val[3] = val[4] = val[5] = -HUGE_VAL;
}

static void _rkJointFloatGetMax(void *prp, double *val){
  val[0] = val[1] = val[2] = val[3] = val[4] = val[5] = HUGE_VAL;
}
...
static void _rkJointFloatCRBWrench(void *prp, rkMP *crb, zVec6D wi[]){
  zMat3D icrb;
  zVec3D a;
  int i;
...
static void _rkJointFloatCRBXform(void *prp, zFrame3D *f, zVec6D si[]){
  zMat3D r;
  int i;
