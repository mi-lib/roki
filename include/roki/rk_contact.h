 ...
 */
__ROKI_EXPORT void rkContactInfoArrayDestroy(rkContactInfoArray *ci);
...
__ROKI_EXPORT rkContactInfoArray *rkContactInfoArrayFromZTK(rkContactInfoArray *carray, ZTK *ztk);
